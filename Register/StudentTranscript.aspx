<%@ Page Title="" Language="C#" MasterPageFile="~/Register/MasterRegister.master" AutoEventWireup="true" CodeFile="StudentTranscript.aspx.cs" Inherits="Register_StudentMovingLevel" %>
        ...
        <table class="auto-style9" style="border-style: solid solid none solid; border-width: thin; border-color: #003366; padding-top:1px;">
            ...
            <tr>
                ...
                <td style="width: 75%; height: 32px; background-color: #F7F6F3;">
                    <strong>
                    <asp:Button ID="Button1" runat="server" Text="Search" OnClick="Button1_Click" style="font-weight: bold; color: #FFFFFF;" CssClass="newStyle1" Height="30px" Width="72px" />
                    </strong>
                </td>
            </tr>
            <tr><td>
